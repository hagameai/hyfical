...
class GitOperations:
    ...
    @staticmethod
    def check_status(repo_name):
        """
        Checks the status of the specified Git repository.

        :param repo_name: Name of the repository.
        :return: Status message of the repository.
        """
        try:
            result = subprocess.check_output(['git', 'status'], cwd=repo_name).decode('utf-8')
            return result
    ...
    def clone_repository(repo_url, clone_dir):
        ...
        try:
            ...
            print(f"Repository cloned from '{repo_url}' to '{clone_dir}' successfully.")
            return True
        except Exception as e:
