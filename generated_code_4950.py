...
class GitOperations:
    ...
    def commit_changes(repo_name, commit_message):
        ...
        :param commit_message: Commit message to be used.
    ...
    def clone_repository(repo_url, clone_dir):
        ...
        :param repo_url: URL of the repository to be cloned.
    ...
    def list_files(repo_name):
        """
        Lists files in the specified Git repository.

        :param repo_name: Name of the repository to list files from.
        :return: List of files in the repository directory.
        """
        try:
