...
class GitOperations:
    ...
    def get_status(repo_name):
        ...
        :return: Status string from the Git repository.
        """
        try:
    ...
    def clone_repository(repo_url, destination):
        """
        Clones a Git repository from the specified URL to the destination path.

        :param repo_url: URL of the repository to clone.
        :param destination: Local path to clone the repository into.
        ...
        try:
            ...
            print(f"Repository cloned from '{repo_url}' to '{destination}'.")
            return True
        except Exception as e:
