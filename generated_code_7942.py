...
class GitOperations:
    ...
    def add_file(repo_name, file_name):
        ...
        :param repo_name: Path to the Git repository.
    ...
    def status(repo_name):
        ...
        :param repo_name: Path to the Git repository.
        :return: Status output from the Git command.
        """
        try:
            status_output = subprocess.check_output(['git', 'status'], cwd=repo_name, text=True)
            print(status_output)
