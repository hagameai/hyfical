...
class GitOperations:
    ...
    def add_file(repo_name, file_name):
        ...
        :param repo_name: Directory of the repository.
    ...
    def list_commits(repo_name):
        """
        Lists commits in the specified Git repository.

        :param repo_name: Directory of the repository.
        :return: List of commit messages.
        """
        try:
            commits = subprocess.check_output(['git', 'log', '--oneline'], cwd=repo_name).decode('utf-8')
