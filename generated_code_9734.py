...
class GitOperations:
    ...
    def add_file(repo_name, file_name):
        """
        Adds a file to the specified Git repository and stages it.

        :param repo_name: Name of the repository.
        :param file_name: Name of the file to be added.
        :return: True if the file was added and staged successfully, False otherwise.
        """
        try:
            ...
            print(f"File '{file_name}' added and staged successfully.")
            return True
        except Exception as e:
    ...
    def commit_changes(repo_name, commit_message):
        """
        Commits staged changes in the specified Git repository.
    ...
    def get_status(repo_name):
        ...
        :param repo_name: Name of the repository.
        :return: Status output as a string.
        """
        try:
            status = subprocess.check_output(['git', 'status'], cwd=repo_name, text=True)
            return status
        except Exception as e:
