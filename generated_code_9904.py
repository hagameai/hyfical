...
class GitOperations:
    ...
    def add_file(repo_name, file_name, content):
        ...
        :param repo_name: Name of the repository to add the file to.
    ...
    def commit_changes(repo_name, message):
        ...
        :param repo_name: Name of the repository to commit changes.
    ...
    def status(repo_name):
        ...
        :param repo_name: Name of the repository to check status.
        :return: Status output as string.
        """
        try:
            status_output = subprocess.check_output(['git', 'status'], cwd=repo_name).decode()
