...
class TestGitOperations(unittest.TestCase):
    ...
    def test_add_file(self):
        ...
        with open(os.path.join(self.repo_name, file_name), 'w') as f:
            f.write("Hello, World!")
        self.assertTrue(os.path.isfile(os.path.join(self.repo_name, file_name)), "File should exist in the repository.")
    ...
    def test_commit_changes(self):
        ...
        with open(os.path.join(self.repo_name, file_name), 'w') as f:
            f.write("Hello, World!")
        # Simulating git commit (you need to implement commit method in GitOperations)
